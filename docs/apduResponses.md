...
These are the errors that can be sent back from the reader
...
| 9D  | 42  | E | Set MSM Controls data length less than 2
...
[Source](https://emv.cool/2020/12/23/Complete-list-of-APDU-responses/)
